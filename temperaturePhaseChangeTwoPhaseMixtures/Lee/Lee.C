...
Foam::temperaturePhaseChangeTwoPhaseMixtures::Lee::Lee
(
...
Foam::temperaturePhaseChangeTwoPhaseMixtures::Lee::mDotAlphal() const
{
...
Foam::Pair<Foam::tmp<Foam::volScalarField>>
Foam::temperaturePhaseChangeTwoPhaseMixtures::Lee::mDot() const
{
...
Foam::Pair<Foam::tmp<Foam::volScalarField>>
Foam::temperaturePhaseChangeTwoPhaseMixtures::Lee::mDotDeltaT() const
{
    volScalarField limitedAlpha1
    (
        min(max(mixture_.alpha1(), scalar(0)), scalar(1))
...
Foam::temperaturePhaseChangeTwoPhaseMixtures::Lee::TSource() const
{
...
void Foam::temperaturePhaseChangeTwoPhaseMixtures::Lee::correct()
{
}


bool Foam::temperaturePhaseChangeTwoPhaseMixtures::Lee::read()
{
